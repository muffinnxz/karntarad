...
import { FeatureCardAdvanced } from "@/components/ui/landing-page/feature-card-advanced";
    ...
    return (
        <div className="flex flex-col min-h-screen w-full overflow-x-hidden">
            ...
            <main className="flex-1 w-full">
                {/* Hero Section */}
                <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 min-h-[calc(100vh-4rem)]">
                    <div className="container mx-auto max-w-full px-4 md:px-6 h-full flex items-center">
                        <div className="grid gap-6 lg:grid-cols-[1fr_40%] lg:gap-12 xl:grid-cols-[1fr_50%] items-center w-full">
                            <motion.div
                                initial="hidden"
                            ...
                            >
                                <div className="space-y-2">
                                    ...
                                    <p className="max-w-full text-muted-foreground md:text-xl">
                                        Karntarad is a gamified platform where
                                        users create, manage, and challenge
                                        themselves with social marketing
                                        scenarios.
                                    </p>
                                </div>
                ...
                >
                    <div className="container mx-auto max-w-full px-4 md:px-6">
                        ...
                        <motion.div
                            ...
                            className="mx-auto grid max-w-7xl gap-6 py-12 lg:grid-cols-3"
                        >
                            <motion.div
                                variants={slideUp}
                            ...
                            >
                                <Card className="flex flex-col h-full">
                                    <CardHeader>
                                        ...
                                        <CardDescription>
                                            For agencies with custom solutions
                                        </CardDescription>
                                    </CardHeader>
                                    <CardContent className="flex-grow">
                                        <div className="text-4xl font-bold">
            ...
            >
                <div className="container mx-auto max-w-full flex flex-col items-center justify-center gap-4 px-4 md:px-6 md:flex-row md:justify-between">
                    <div className="flex flex-col items-center gap-4 md:items-start md:gap-2">
                        ...
                        <p className="text-center text-sm text-muted-foreground md:text-left">
                            A gamified platform for mastering social marketing
                            scenarios.
                        </p>
                    </div>
                ...
                <div className="container mx-auto max-w-full flex flex-col items-center justify-center gap-4 border-t py-4 md:flex-row md:justify-between md:py-6 px-4 md:px-6">
                    <p className="text-center text-sm text-muted-foreground md:text-left">
